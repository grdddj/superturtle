## Current Task
Add test: Article creation — use Convex client to create article post, verify it has articleTitle and articleBody fields.
...
- [ ] Add test: Article creation — use Convex client to create article post, verify it has articleTitle and articleBody fields <- current
