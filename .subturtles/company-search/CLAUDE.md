...
- [ ] Create `src/components/company/CompanySuggestions.js` widget — query up to 5 companies the user does NOT follow, show cards with logo, name, industry, "Follow" button. Style like existing sidebar widgets. <- current
