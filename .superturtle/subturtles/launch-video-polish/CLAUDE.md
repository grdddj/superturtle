# Current task
Polish Scene 4 (Teleport) in PhoneLaunchVideo.tsx: tighten the card, smooth the beam animation without jumps, and make the /teleport badge more prominent.
...
- [ ] Polish Scene 4 (Teleport): tighten card, smooth beam animation without jumps, make /teleport badge more prominent <- current
