...
- Avoid touching unrelated repo files unless necessary.
- Remain a valid canonical SubTurtle state file.
...
- Start.
- Stay idle safely.
- Allow the supervisor flow to observe the running worker.
