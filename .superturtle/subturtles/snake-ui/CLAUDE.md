...
Build the game over screen in the menu overlay for the fractal/Fibonacci snake game in snake-game/ui.js and snake-game/styles.css, showing final score, fibonacci level reached, high score comparison, and a play again button.
The start screen overlay is done; the next slice is the first end-state menu screen.
...
- [ ] Build game over screen showing final score and fibonacci level reached and high score comparison with play again button <- current
